{
  ...
  let
    ...
    robotApiPkg = pkgs.stdenv.mkDerivation {
      ...
      # If you already have your compiled JS in the repo (e.g. checked-in dist/),
      # you can skip a build and just copy.
      buildPhase = ''
        # no-op build; we just ship the sources + built JS
        :
      '';
      ...
      installPhase = ''
        ...
        # Simple wrapper that runs your API.
        # Change dist/main.js to whatever your real entrypoint is.
